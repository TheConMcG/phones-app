...
class CamerasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create camera" do
    assert_difference('Camera.count') do
      post cameras_url, params: { camera: { description: @camera.description, lense_size: @camera.lense_size, megapixels: @camera.megapixels } }
    end
  ...
  test "should update camera" do
    patch camera_url(@camera), params: { camera: { description: @camera.description, lense_size: @camera.lense_size, megapixels: @camera.megapixels } }
